...
require_once("../include/config.php");
  ...
  if ($insert_identitas == true) {
    ...
    $_SESSION['msg_content'] = "Berhasil! Data Yang Kamu Kirimkan Berhasil Di Input dengan PID <a href='{$base}data/edit.php?pid={$pid}'><b>{$pid}</b></a>";
  ...
  $_SESSION['msg_content'] = 'Gagal! Sistem Error, Periksa Kembali Seluruh Form Yang Telah Anda Input.';
  header("location:".$_POST['redirect']);
  }
  } else {
  $_SESSION['msg_type'] = 'error';
  $_SESSION['msg_content'] = 'Gagal! ID Untuk Identitas Bencana Ini Telah Terdaftar, Silahkan Kirim Ulang Melalui Tombol Submit.';
  header("location:".$_POST['redirect']);
  }
